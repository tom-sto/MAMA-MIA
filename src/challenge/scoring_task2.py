...
if __name__ == '__main__':
    ...
    # Define paths (modify as needed)
    data_dir = r'nnUNet_results\Dataset200_global_local_4ch_breast\nnUNetTrainer__nnUNetPlans__3d_fullres\fold_4_pcr_transformer_more_classifier_no_metadata\outputs'  # Path to the data directory
    clinical_data_xlsx = 'E:/MAMA-MIA/clinical_and_imaging_info.xlsx' # Path to the clinical data
    output_csv = f'{data_dir}/results_task2.csv'
    output_plots_dir = f'{data_dir}/plots'
